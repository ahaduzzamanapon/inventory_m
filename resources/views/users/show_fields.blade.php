...
<tr>
    <th scopre="row">{!! Form::label('salary', 'Salary:') !!}</th>
    <td>{{ $users->salary }}</td>
</tr>


<tr>
    <th scopre="row">{!! Form::label('nid', 'Nid:') !!}</th>
    <td>{{ $users->nid }}</td>
</tr>
...
<tr>
    <th scopre="row">{!! Form::label('education', 'Education:') !!}</th>
...
<tr>
    <th scopre="row">{!! Form::label('punch_id', 'Punch Id:') !!}</th>
    <td>{{ $users->punch_id }}</td>
</tr>
...
<tr>
    <th scopre="row">{!! Form::label('experience', 'Experience:') !!}</th>
